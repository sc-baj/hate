...
class instagram:
	...
	def useragent(self):
		...
		useragent = f'''ozilla/5.0 (Linux; Android 11; SM-N985F Build/RP1A.200720.012;wv) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36'''  
		return useragent
